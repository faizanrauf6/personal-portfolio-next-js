...
<CodeBlock
    ...
    <Row fillWidth horizontal="center">
      <Card
        ...
        gap="8"
      >
        <SmartImage src="/images/projects/project-01/hc-cover1.png" aspectRatio="16/9" radius="l" sizes="400px" />
...
<CodeBlock
    ...
    topRadius="l"
    codeHeight={24}
    codePreview={<SmartImage src="/images/projects/project-01/mahir-cover1.jpg" alt="Example image" sizes="640px" aspectRatio="16/9" radius="l" />}
    codeInstances={[
      {
        code:
`<SmartImage
    src="/images/projects/project-01/ses-cover1.png"
    sizes="640px"
    alt="Example image"
    aspectRatio="16/9"
    radius="l"
