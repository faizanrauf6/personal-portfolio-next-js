---
title: "Updating the content of your Portfolio"
...
Replace the `public/images/avatar-p.jpg` file with your own avatar image. It is used on the `/about` page as well as on the dynamically generated `open-graph` images.
...
`const home = {
    ...
    subline: (
      <>
        I'm Faizan, a Senior Software Engineer at <InlineCode>FLY</InlineCode>, where I craft intuitive
